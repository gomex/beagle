...
export function createBeagleView(service: BeagleService, networkOptions: NetworkOptions) {
  console.log('>>>>>>>>')
  console.log(networkOptions)
  const view = service.createView(networkOptions) as JsBridgeBeagleView
  view.id = `${nextViewId++}`
